...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	antigravityOAuthService := service.NewAntigravityOAuthService(configConfig, proxyRepository)
	...
	antigravityQuotaFetcher := service.NewAntigravityQuotaFetcher(configConfig, proxyRepository)
